...
export default function ResultPage() {
  ...
  const s = {
    main: { maxWidth:480, margin:'0 auto', padding:'0 20px 80px', minHeight:'100vh', background:'linear-gradient(135deg,#12072B 0%,#1a0a3d 50%,#0d1a3d 100%)', animation:'fadeIn 0.6s ease' } as React.CSSProperties,
    header: { padding:'28px 0 20px', borderBottom:'1px solid rgba(255,255,255,0.1)', marginBottom:24 } as React.CSSProperties,
    ...
    typeCard: { background:'linear-gradient(135deg,rgba(255,78,205,0.2),rgba(139,92,246,0.2))', border:'1px solid rgba(255,78,205,0.4)', borderRadius:24, padding:'24px 20px', marginBottom:20, textAlign:'center' as const, boxShadow:'0 0 30px rgba(255,78,205,0.2)' },
    typeLabel: { fontSize:12, color:'#D8B4FE', letterSpacing:'0.08em', marginBottom:10 } as React.CSSProperties,
    typeValue: { fontSize:24, fontWeight:800, display:'flex', alignItems:'center', justifyContent:'center', gap:10, background:'linear-gradient(90deg,#FF4ECD,#8B5CF6)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent' } as React.CSSProperties,
    section: { background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:20, padding:'22px 20px', marginBottom:14, backdropFilter:'blur(10px)' } as React.CSSProperties,
    adviceSection: { background:'rgba(255,78,205,0.08)', border:'1px solid rgba(255,78,205,0.3)', borderRadius:20, padding:'22px 20px', marginBottom:14, boxShadow:'0 0 20px rgba(255,78,205,0.1)' } as React.CSSProperties,
    ...
    caveat: { background:'rgba(255,155,234,0.1)', borderLeft:'4px solid #FF9BEA', borderRadius:'0 12px 12px 0', padding:'14px 16px', marginBottom:20, fontSize:14, color:'#FF9BEA', lineHeight:1.7 } as React.CSSProperties,
    automationSection: { background:'rgba(56,189,248,0.08)', border:'1px solid rgba(56,189,248,0.2)', borderRadius:20, padding:20, marginBottom:28 } as React.CSSProperties,
    ...
    lineBox: { background:'rgba(6,199,85,0.08)', border:'1px solid rgba(6,199,85,0.3)', borderRadius:20, padding:'22px 20px', marginBottom:16 } as React.CSSProperties,
    ...
    lineBtn: { display:'block', width:'100%', background:'linear-gradient(90deg,#06C755,#00a844)', color:'#fff', fontSize:17, fontWeight:700, padding:18, borderRadius:14, textAlign:'center' as const, boxShadow:'0 0 20px rgba(6,199,85,0.3)' } as React.CSSProperties,
    ...
    meetingBtn: { display:'block', width:'100%', background:'linear-gradient(90deg,#FF4ECD,#8B5CF6)', color:'#fff', fontSize:15, fontWeight:700, padding:16, borderRadius:14, textAlign:'center' as const, boxShadow:'0 0 20px rgba(255,78,205,0.3)' } as React.CSSProperties,
    ...
    errCard: { margin:'60px auto', background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:20, padding:'32px 20px', textAlign:'center' as const } as React.CSSProperties,
    retryBtn: { marginTop:20, background:'linear-gradient(90deg,#FF4ECD,#8B5CF6)', color:'#fff', padding:'14px 28px', borderRadius:14, fontSize:15, fontWeight:700, border:'none', cursor:'pointer' } as React.CSSProperties,
